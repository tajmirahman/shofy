                                ...
                                <div class="profile__main">
                                            ...
                                            <div class="col-md-6">
                                                <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="profile__main-content">
                                                        ...
                                                        <h4 class="profile__main-title ">Welcome <span
                                                                class="text-primary">{{ $profileData->name }}</span> !
                                                        </h4>
                                    ...
                                    <div class="profile__main-info">
                                        <div class="row gx-3">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="profile__main-info-item">
                                                    <div class="profile__main-info-icon">
                                                        <span>
                                                            <span
                                                                class="profile-icon-count profile-order">{{ count($orders) }}</span>
                                            ...
                                            @php
                                                $id = Auth::user()->id;
                                                $wishlist = App\Models\WishList::where('user_id', $id)->get();
                                            @endphp
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="profile__main-info-item">
                                                    <div class="profile__main-info-icon">
                                                        ...
                                                        <span>
                                                            <span
                                                                class="profile-icon-count profile-wishlist">{{ count($wishlist) }}</span>
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="profile__main-info-item">
                                                    ...
                                                    <h4 class="profile__main-info-title">Deliver</h4>
                                                </div>
                                            </div>
