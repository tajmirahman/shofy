                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" action="{{ route('update.state') }}" method="POST">
                                    @csrf
                                            ...
                                            <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                                ...
                                                @foreach ($division as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $editstate->division_id == $item->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <select class="form-select" name="district_id">
                                                ...
                                                @foreach ($district as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $editstate->district_id == $item->id ? 'selected' : '' }}>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input type="text" value="{{ $editstate->state_name }}" autocomplete="off"
