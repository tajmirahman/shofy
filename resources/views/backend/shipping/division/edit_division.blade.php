                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" action="{{ route('update.division') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input type="text" value="{{$editdivision->division_name}}" autocomplete="off" name="division_name" class="form-control" />
                                        </div>
                                    </div>
