    ...
    <div class="page-content">
                            ...
                            <div class="col-lg-7">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="editor" name="long_descp" rows="5">{!! $editproduct->long_descp !!}</textarea>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('store.vendor.multiimg') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <form action="{{route('update.vendor.multiimg')}}" method="POST" enctype="multipart/form-data">
                            ...
                            @foreach ($multiimg as $key => $img)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('delete.vendor.multiimg', $img->id) }}" id="delete"
