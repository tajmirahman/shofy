                                ...
                                <form id="myForm" action="{{ route('store.slider') }}" method="POST"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input type="text" autocomplete="off" name="slider_title"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input type="text" autocomplete="off" name="slider_subtitle"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-inverse-primary px-3" value="Add Slider" />
                                        </div>
                                    </div>
