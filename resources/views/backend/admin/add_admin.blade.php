                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" action="{{ route('store.admin') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary  @error('phone') is-invalid @enderror">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary  @error('address') is-invalid @enderror">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <select class="form-select form-select-sm @error('roles') is-invalid @enderror"
                                                aria-label=".form-select-sm example" name="roles">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-inverse-primary px-3" value="Add Admin" />
                                        </div>
                                    </div>
