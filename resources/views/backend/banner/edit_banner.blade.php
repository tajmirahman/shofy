                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" action="{{ route('update.banner') }}" method="POST"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input type="text" value="{{$editbanner->banner_title}}" autocomplete="off" name="banner_title"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input type="text" value="{{$editbanner->banner_subtitle}}"  autocomplete="off" name="banner_subtitle"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            ...
                                            <img src="{{ asset($editbanner->image) }}" alt="" id="showImage"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-inverse-primary px-3" value="Update Banner" />
                                        </div>
                                    </div>
