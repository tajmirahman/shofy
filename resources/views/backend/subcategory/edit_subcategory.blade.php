                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" action="{{ route('update.subcategory') }}" method="POST"
                                    ...
                                    <input type="hidden" name="id" value="{{$editsubcat->id}}">
                                    <input type="hidden" name="old_image" value="{{$editsubcat->image}}">
                                            ...
                                            <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="category_id">
                                                ...
                                                @foreach ($category as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $editsubcat->category_id == $item->id ? 'selected' : '' }}>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input type="text" value="{{ $editsubcat->subcategory_name }}"
                                                autocomplete="off" name="subcategory_name" class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            ...
                                            <img src="{{ asset($editsubcat->image) }}" alt="" id="showImage"
