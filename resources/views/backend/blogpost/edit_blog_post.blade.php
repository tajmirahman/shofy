            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit BlogPost</li>
                    </ol>
                </nav>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form id="myForm" action="{{ route('update.blog.post') }}" method="POST"
                                            ...
                                            <select name="blogcat_id" class="form-select">
                                                ...
                                                @foreach ($blogcat as $item)
                                                    <option value="{{ $item->id }}"
                                                        ...
                                                        {{ $item->blog_category_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <input type="text" value="{{ $editpost->post_title }}" autocomplete="off"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <textarea class="form-control" name="short_descp" rows="3">{{ $editpost->short_descp }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <textarea class="form-control mb-4" id="editor" name="long_descp">{!! $editpost->long_descp !!}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2 mt-5">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            ...
                                            <img src="{{ asset($editpost->image) }}" alt="" id="showImage"
