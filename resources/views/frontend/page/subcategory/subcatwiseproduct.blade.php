...
<section class="breadcrumb__area text-center include-bg pt-80 pb-120">
    <div class="container">
        <div class="row">
            <div class="col-xxl-12">
                <div class="breadcrumb__content p-relative z-index-1">
                    <h3 class="breadcrumb__title">{{ $subbreadcat->subcategory_name }}</h3>
                    <div class="breadcrumb__list">
                        <span><a href="{{ route('index') }}">Home</a></span>
                        <span>{{ $subbreadcat->subcategory_name }}</span>
                    </div>
                </div>
            </div>
        </div>
