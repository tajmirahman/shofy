                        ...
                        <form action="{{ route('store.contact.message') }}" method="POST">
                            ...
                            <div class="tp-contact-input-box">
                                <div class="tp-contact-input">
                                    <input name="name" autocomplete="off" id="name" type="text"
                                        placeholder="Name">
                                </div>
                            ...
                            <div class="tp-contact-input-box">
                                <div class="tp-contact-input">
                                    <input name="email" autocomplete="off" id="email" type="email"
                            ...
                            <div class="tp-contact-input-box">
                                <div class="tp-contact-input">
                                    <input name="subject" autocomplete="off" id="subject" type="text"
                            ...
                            <div class="tp-contact-input-box">
                                <div class="tp-contact-input">
                                    <textarea id="message" autocomplete="off" name="message" placeholder="Write your message here..."></textarea>
                                </div>
                                <div class="tp-contact-input-title">
                    ...
                    <div class="tp-contact-info-wrapper">
                        <div class="tp-contact-info-item">
                            <div class="tp-contact-info-icon">
                                <span>
                                    <img src="{{ asset('frontend/assets/img/contact/contact-icon-1.png') }}"
                                        alt="">
                                </span>
                            </div>
                            <div class="tp-contact-info-content">
                                <p data-info="mail"><a href="mailto:contact@shofy.com">contact@shofy.com</a></p>
                                <p data-info="phone"><a href="tel:670-413-90-762">0{{ $site->phone }}</a></p>
                            </div>
                        </div>
                        <div class="tp-contact-info-item">
                            <div class="tp-contact-info-icon">
                                <span>
                                    <img src="{{ asset('frontend/assets/img/contact/contact-icon-2.png') }}"
                                        alt="">
                                </span>
                            </div>
                            <div class="tp-contact-info-content">
                        ...
                        <div class="tp-contact-info-item">
                            <div class="tp-contact-info-icon">
                                <span>
                                    <img src="{{ asset('frontend/assets/img/contact/contact-icon-3.png') }}"
                                        alt="">
                                </span>
                            </div>
                            <div class="tp-contact-info-content">
            ...
            <div class="col-xl-12">
                <div class="tp-map-wrapper">
                    ...
                    <div class="tp-map-iframe">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3652.225289295877!2d90.42916147502388!3d23.7393442892013!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b93219951ff9%3A0x9902c5d703483016!2sEast%20basaboo!5e0!3m2!1sbn!2sbd!4v1699036019982!5m2!1sbn!2sbd"
