...
<section class="breadcrumb__area text-center include-bg pt-80 pb-20">
    <div class="container">
        <div class="row">
            <div class="col-xxl-12">
                <div class="breadcrumb__content p-relative z-index-1">
                    <h3 class="breadcrumb__title">{{ $breadcat->category_name }}</h3>
...
<section class="tp-product-category pt-50 pb-20">
    <div class="container">
        <div class="row row-cols-xl-6 row-cols-lg-6 row-cols-md-4">

            @foreach ($subcategorys as $subcategory)
                @php
                    $subcountproduct = App\Models\Product::where('subcategory_id', $subcategory->id)->get();
                @endphp
                ...
                <div class="col">
                    <div class="tp-product-category-item text-center mb-40">
                        <div class="tp-product-category-thumb fix">
                            ...
                            <a href="{{ route('subcatwise.product', $subcategory->id) }}">
                                <img src="{{ asset($subcategory->image) }}" alt="product-category">
                            </a>
                        ...
                        <div class="tp-product-category-content">
                            <h3 class="tp-product-category-title">
                                ...
                                <a
                                    href="{{ route('subcatwise.product', $subcategory->id) }}">{{ $subcategory->subcategory_name }}</a>

                            </h3>
                            <p>{{ count($subcountproduct) }} Product</p>
                        </div>
                    </div>
                </div>
            @endforeach
                            ...
                            <div class="tp-shop-widget-categories">
                                <ul>
                                    @foreach ($categorys as $category)
                                        @php
                                            $countproduct = App\Models\Product::where('category_id', $category->id)->get();
                                        @endphp

                                        <li><a href="{{ route('catwise.product', $category->id) }}">{{ $category->category_name }}
                                                <span>{{ count($countproduct) }}</span></a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                ...
                <div class="tp-shop-main-wrapper">
                    ...
                    <div class="tp-shop-items-wrapper tp-shop-item-primary">
                        ...
                        <div class="tab-content" id="productTabContent">
                            ...
                            <div class="tab-pane fade show active" id="grid-tab-pane" role="tabpanel"
                                ...
                                <div class="row infinite-container gy-3">
                    ...
                    <div class="tp-shop-pagination mt-20">
                        <div class="tp-pagination">
                            ...
                            {{ $products->links('vendor.pagination.custom_paginate') }}
