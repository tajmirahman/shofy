                ...
                <div class="tp-slider-item tp-slider-height d-flex align-items-center swiper-slide green-dark-bg">
                    ...
                    <div class="tp-slider-shape">
                        <img class="tp-slider-shape-1"
                            src="{{ asset('frontend/assets/img/slider/shape/slider-shape-1.png') }}" alt="slider-shape">
                        <img class="tp-slider-shape-2"
                            src="{{ asset('frontend/assets/img/slider/shape/slider-shape-2.png') }}" alt="slider-shape">
                        <img class="tp-slider-shape-3"
                            src="{{ asset('frontend/assets/img/slider/shape/slider-shape-3.png') }}" alt="slider-shape">
                        <img class="tp-slider-shape-4"
                            src="{{ asset('frontend/assets/img/slider/shape/slider-shape-4.png') }}" alt="slider-shape">
                    </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-5 col-lg-6 col-md-6">
                                <div class="tp-slider-content p-relative z-index-1">
                                    <span>Special at <b>month</b></span>
                                    <h4 class="tp-slider-title">{{ $slider->slider_title }}</h4>
