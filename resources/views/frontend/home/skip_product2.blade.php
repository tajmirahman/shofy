@php
    $skip_subcat_5 = App\Models\SubCategory::skip(5)->first();

    $skip_product_5 = App\Models\Product::where('status', '1')
        ->where('subcategory_id', $skip_subcat_5->id)
        ->orderBy('id', 'ASC')
        ->limit(8)
        ->get();
@endphp
        ...
        <div class="row align-items-end">
            <div class="col-xl-5 col-sm-6">
                <div class="tp-section-title-wrapper mb-40">
                    <h3 class="tp-section-title">{{ $skip_subcat_5->subcategory_name }}
