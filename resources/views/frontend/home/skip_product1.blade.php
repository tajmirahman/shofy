@php
    $skip_subcat_2 = App\Models\SubCategory::skip(2)->first();

    $skip_product_2 = App\Models\Product::where('status', '1')
        ->where('subcategory_id', $skip_subcat_2->id)
        ->orderBy('id', 'ASC')
        ->limit(8)
        ->get();
@endphp
        ...
        <div class="row align-items-end">
            <div class="col-xl-5 col-sm-6">
                <div class="tp-section-title-wrapper mb-40">
                    <h3 class="tp-section-title">{{ $skip_subcat_2->subcategory_name }}
                                    ...
                                    <div class="tp-product-thumb p-relative fix m-img">
                                        ...
                                        <div class="tp-product-action">
                                            <div class="tp-product-action-item d-flex flex-column">
                                                ...
                                                <a type="submit" id="{{$product->id}}" onclick="productView(this.id)" class="tp-product-action-btn tp-product-quick-view-btn"
