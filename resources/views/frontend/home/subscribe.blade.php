<section class="tp-subscribe-area pt-70 pb-65 theme-bg p-relative z-index-1">
    <div class="tp-subscribe-shape">
       <img class="tp-subscribe-shape-1" src="{{asset('frontend/assets/img/subscribe/subscribe-shape-1.png')}}" alt="">
       <img class="tp-subscribe-shape-2" src="{{asset('frontend/assets/img/subscribe/subscribe-shape-2.png')}}" alt="">
       <img class="tp-subscribe-shape-3" src="{{asset('frontend/assets/img/subscribe/subscribe-shape-3.png')}}" alt="">
       <!-- plane shape -->
       <div class="tp-subscribe-plane">
          <img class="tp-subscribe-plane-shape" src="{{asset('frontend/assets/img/subscribe/plane.png')}}" alt="">
       ...
       <div class="row align-items-center">
          <div class="col-xl-7 col-lg-7">
             <div class="tp-subscribe-content">
                <span>Sale 20% off all product</span>
                ...
                <form action="{{route('subscribe')}}" method="POST">
                  @csrf
                   ...
                   <div class="tp-subscribe-input">
                      <input type="email" autocomplete="off" name="subscribe" placeholder="Enter Your Email">
