                        ...
                        <div class="tp-header-top-right d-flex align-items-center justify-content-end">
                            <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                                <div class="tp-header-top-menu-item tp-header-lang">
                                    <span class="tp-header-lang-toggle" id="tp-header-lang-toggle">Language</span>
                                    <ul>
                                        <li>
                                            <a href="javascript:;">Bangla</a>
                                        </li>
                                        <li>
                                ...
                                <div class="tp-header-top-menu-item tp-header-currency">
                                    <span class="tp-header-currency-toggle"
                                        id="tp-header-currency-toggle">Currency</span>
                                    <ul>
                                        <li>
                                ...
                                <div class="tp-header-top-menu-item tp-header-setting">
                                    <span class="tp-header-setting-toggle" id="tp-header-setting-toggle">Account</span>
                                    <ul>
                                        <li>
                            ...
                            <div class="tp-header-action d-flex align-items-center ml-50">
                                ...
                                <div class="tp-header-action-item d-none d-lg-block">
                                    <a href="{{ route('wishlist') }}" class="tp-header-action-btn">
                                        ...
                                        <span class="tp-header-action-badge" id="wishQty">0</span>
                                    </a>
                                </div>
                                {{-- wishlist --}}
                                ...
                                <div class="tp-header-action-item">
                                    <button type="button" class="tp-header-action-btn cartmini-open-btn">
                                        ...
                                        <span class="tp-header-action-badge" id="cartQty"></span>
                                    </button>
                                </div>
                                {{-- cart --}}
                            ...
                            <div class="tp-header-category tp-category-menu tp-header-category-toggle">
                                ...
                                <nav class="tp-category-menu-content">
                                    <ul>
                                        @foreach ($categorys as $category)
                                            @php
                                                $subcategorys = App\Models\SubCategory::where('category_id', $category->id)->get();
                                            @endphp
                            ...
                            <div class="main-menu menu-style-1">
                                <nav class="tp-main-menu-content">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('all.category.front') }}">Category</a>
                                        </li>

                                        <li>
                                            <a href="{{ route('total-product') }}">Product</a>
                                        </li>

                                        <li>
                                            <a href="{{ route('index') }}">Coupon</a>
                                        </li>

                                        <li>
                                            <a href="{{ route('total.blog-post') }}">Blog</a>
                                        </li>
                        ...
                        <div class="col-xl-3 col-lg-3">
                            <div class="tp-header-contact d-flex align-items-center justify-content-end">
                                ...
                                <div class="tp-header-contact-content">
                                    <h5>Hotline:</h5>
                                    <p><a href="tel:402-763-282-46">+(088) {{ $site->phone }}</a></p>
                                </div>
                            </div>
                        </div>
...
@include('frontend.body.header_sticky')
