                                            ...
                                            <div class="col-md-6">
                                                <div class="profile__main-inner d-flex flex-wrap align-items-center">
                                                    <div class="profile__main-thumb">
                                                        <img src="{{ !empty($profileData->photo) ? url('upload/user_images/' . $profileData->photo) : url('upload/user.png') }}"
                                                            alt="">
                                                    ...
                                                    <div class="profile__main-content">
                                                        ...
                                                        <h4 class="profile__main-title ">Welcome <span class="text-primary">{{$profileData->name}}</span> !</h4>
                                        ...
                                        <form action="{{route('user.profile.store')}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row gy-3">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                    <input type="text" name="name" autocomplete="" placeholder="Enter your name" value="{{$profileData->name}}">
                                                </div>

                                                <div class="col-xxl-6 col-md-6">
                                                    <input type="text" name="username" autocomplete="" placeholder="Enter your username" value="{{$profileData->username}}">
                                                </div>

                                                <div class="col-xxl-6 col-md-6">
                                                    <input type="email" name="email" autocomplete="" placeholder="Enter your Email" value="{{$profileData->email}}">
                                                </div>

                                                <div class="col-xxl-6 col-md-6">
                                                    <input type="text" name="phone" autocomplete="" placeholder="Enter your Phone" value="{{$profileData->phone}}">
                                                </div>

                                                <div class="col-xxl-12 col-md-12">
                                                    <input type="text" name="address" autocomplete="" placeholder="Enter your Address" value="{{$profileData->address}}">
                                                </div>
