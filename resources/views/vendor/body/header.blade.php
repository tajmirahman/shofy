                                ...
                                <div class="row gx-0 gy-2 row-cols-3 justify-content-center p-2">
                                    ...
                                    <div class="col">
                                        <a href="javascript:;">
                                            <div class="app-box text-center">
                                                <div class="app-icon">
                                                    <img src="{{ asset('backend/assets/') }}images/app/stack-overflow.png"
                                                        width="30" alt="">
                                                </div>
                                                <div class="app-name">
                                    ...
                                    <div class="col">
                                        <a href="javascript:;">
                                            <div class="app-box text-center">
                                                <div class="app-icon">
                                                    <img src="{{ asset('backend/assets/') }}images/app/figma.png"
                                                        width="30" alt="">
                                                </div>
                                                <div class="app-name">
                                                    <p class="mb-0 mt-1">Stack</p>
                                    ...
                                    <div class="col">
                                        <a href="javascript:;">
                                            <div class="app-box text-center">
                                                <div class="app-icon">
                                                    <img src="{{ asset('backend/assets/') }}images/app/twitter.png"
                                                        width="30" alt="">
                                                </div>
                                                <div class="app-name">
                                    ...
                                    <div class="col">
                                        <a href="javascript:;">
                                            <div class="app-box text-center">
                                                <div class="app-icon">
                                                    <img src="{{ asset('backend/assets/') }}images/app/google-calendar.png"
                                                        width="30" alt="">
                                                </div>
                                                <div class="app-name">
                                    ...
                                    <div class="col">
                                        <a href="javascript:;">
                                            <div class="app-box text-center">
                                                <div class="app-icon">
                                                    <img src="{{ asset('backend/assets/') }}images/app/google-photos.png"
                                                        width="30" alt="">
                                                </div>
                                                <div class="app-name">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:;">
                                <div class="msg-header">
                                    ...
                                    <p class="msg-header-badge">Mark All Read</p>
                                </div>
                            </a>
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                    ...
                    <img src="{{ !empty($profileData->photo) ? url('upload/vendor_images/' . $profileData->photo) : url('upload/no_image.jpg') }}"
                        class="user-img" alt="vendor">
                    <div class="user-info">
                        <p class="user-name mb-0 text-center">{{ $profileData->name }}</p>
                        <p class="designattion mb-0">{{ $profileData->email }}</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">

                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('vendor.profile') }}"><i
                                class="bx bx-user fs-5"></i><span>Profile</span></a>
                    </li>

                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('vendor.profile') }}"><i
                                class="bx bx-edit fs-5"></i><span>Edit Profile</span></a>
                    </li>

                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('vendor.password') }}"><i
                                class="bx bx-lock fs-5"></i><span>Password</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('vendor.logout') }}"><i
