...
<!-- Mirrored from hixstudio.net/tphtml/shofy-prv/shofy/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Oct 2023 02:46:45 GMT -->
               ...
               <div class="col-xl-6 col-lg-8 col-md-10">
                  <div class="tp-error-content text-center">
                     <div class="tp-error-thumb">
                        <img src="{{asset('frontend/assets/img/error/500.jpg')}}" alt="">
                     </div>
                     ...
                     <a href="{{route('index')}}" class="tp-error-btn">Back to Home</a>
                  </div>
               </div>
            </div>
         </div>
